    ...
    92077: function (e, r, t) {
      ...
      (n = function () {
        ...
        return (
          ((e = function (t) {
            var i, o, u, s;
            if (e.isNumeral(t)) i = t.value();
            else if (0 === t || "undefined" === typeof t) i = 0;
            else if (null === t || r.isNaN(t)) i = null;
            else if ("string" === typeof t)
              if (a.zeroFormat && t === a.zeroFormat) i = 0;
              else if (
                (a.nullFormat && t === a.nullFormat) ||
                ...
                i = (u = u || e._.stringToNumber)(t);
              }
            else i = Number(t) || null;
            return new l(t, i);
          }).version = t),
          ...
          (e._ = r =
            {
              numberToFormat: function (r, t, n) {
                ...
                if (
                  ...
                  e._.includes(t, "a") &&
                    ...
                    (a >= g && !o) || "t" === o
                      ...
                      : ((a < _ && a >= y && !o) || "k" === o) &&
                        ((p += m.abbreviations.thousand), (r /= y))),
                  e._.includes(t, "[.]") &&
                    ((d = !0), (t = t.replace("[.]", "."))),
                  (l = r.toString().split(".")[0]),
                  (u = t.split(".")[1]),
                  (c = t.indexOf(",")),
                  ...
                  u
                    ? (e._.includes(u, "[")
                        ...
                        : (F = e._.toFixed(r, u.length, n)),
                      (l = F.split(".")[0]),
                      (F = e._.includes(F, ".")
                        ? m.delimiters.decimal + F.split(".")[1]
                        : ""),
                      d && 0 === Number(F.slice(1)) && (F = ""))
                    : (l = e._.toFixed(r, 0, n)),
                  p && !o && Number(l) >= 1e3 && p !== m.abbreviations.trillion)
                )
                ...
                if (
                  (e._.includes(l, "-") && ((l = l.slice(1)), (x = !0)),
                  l.length < b)
                )
                  for (var w = b - l.length; w > 0; w--) l = "0" + l;
                return (
                  c > -1 &&
                    (l = l
                      .toString()
              ...
              toFixed: function (e, r, t, n) {
                ...
                return (
                  (i =
                    2 === u.length ? Math.min(Math.max(u[1].length, s), r) : s),
                  (a = Math.pow(10, i)),
                  (l = (t(e + "e+" + i) / a).toFixed(i)),
                  n > r - i &&
                    ((o = new RegExp("\\.?0{1," + (n - (r - i)) + "}$")),
                    (l = l.replace(o, ""))),
                  l
                );
              },
          ...
          (e.fn = l.prototype =
            {
              ...
              format: function (r, t) {
                var i,
                  ...
                  u = this._value,
                  s = r || a.defaultFormat;
                if (((t = t || Math.round), 0 === u && null !== a.zeroFormat))
                  o = a.zeroFormat;
                else if (null === u && null !== a.nullFormat) o = a.nullFormat;
                else {
                  for (i in n)
                    if (s.match(n[i].regexps.format)) {
                      l = n[i].format;
                      break;
                    }
                  o = (l = l || e._.numberToFormat)(u, s, t);
                }
                return o;
              },
              value: function () {
              ...
              add: function (e) {
                ...
                return (
                  (this._value = r.reduce([this._value, e], n, 0) / t), this
                );
              },
              subtract: function (e) {
                var t = r.correctionFactor.call(null, this._value, e);
                ...
                return (
                  (this._value =
                    r.reduce([e], n, Math.round(this._value * t)) / t),
                  this
                );
              },
              multiply: function (e) {
                function t(e, t, n, i) {
                  ...
                  return (
                    (Math.round(e * o) * Math.round(t * o)) / Math.round(o * o)
                  );
                }
          ...
          e.register("format", "bps", {
            ...
            format: function (r, t, n) {
              var i,
                o = e._.includes(t, " BPS") ? " " : "";
              return (
                (r *= 1e4),
                (t = t.replace(/\s?BPS/, "")),
                (i = e._.numberToFormat(r, t, n)),
                e._.includes(i, ")")
                  ? ((i = i.split("")).splice(-1, 0, o + "BPS"),
                    (i = i.join("")))
                  : (i = i + o + "BPS"),
                i
              );
              ...
              e.register("format", "bytes", {
                ...
                format: function (n, i, o) {
                  var a,
                    l,
                    u,
                    s = e._.includes(i, "ib") ? t : r,
                    c =
                      e._.includes(i, " b") || e._.includes(i, " ib")
                        ? " "
                        : "";
                  for (
                    i = i.replace(/\s?i?b/, ""), a = 0;
                    a <= s.suffixes.length;
                    a++
                  )
                    if (
                      ...
                      (c += s.suffixes[a]), l > 0 && (n /= l);
                      break;
                    }
                  return e._.numberToFormat(n, i, o) + c;
                },
                unformat: function (n) {
                  var i,
                    o,
                  ...
                  if (a) {
                    for (i = r.suffixes.length - 1; i >= 0; i--) {
                      if (e._.includes(n, r.suffixes[i])) {
                        o = Math.pow(r.base, i);
                        break;
                      }
                      if (e._.includes(n, t.suffixes[i])) {
                        o = Math.pow(t.base, i);
                        break;
                      }
                    }
          ...
          e.register("format", "exponential", {
            ...
            format: function (r, t, n) {
              var i = (
                "number" !== typeof r || e._.isNaN(r)
                  ? "0e+0"
                  : r.toExponential()
              ).split("e");
              return (
                (t = t.replace(/e[\+|\-]{1}0/, "")),
                e._.numberToFormat(Number(i[0]), t, n) + "e" + i[1]
              );
            },
            unformat: function (r) {
              ...
              return (
                (i = e._.includes(r, "e-") ? (i *= -1) : i),
                e._.reduce([n, Math.pow(10, i)], o, 1)
              );
            },
          }),
          ...
          e.register("format", "percentage", {
            ...
            format: function (r, t, n) {
              ...
              return (
                ...
                (i = e._.numberToFormat(r, t, n)),
                e._.includes(i, ")")
                  ? ((i = i.split("")).splice(-1, 0, o + "%"), (i = i.join("")))
                  : (i = i + o + "%"),
                i
              );
            },
        ...
        void 0 === (i = "function" === typeof n ? n.call(r, t, r, e) : n) ||
          (e.exports = i);
    },
  },
]);
//# sourceMappingURL=2077-930a204c877fd795.js.map
